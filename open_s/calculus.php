...
<body>
    ...
    <link rel="stylesheet" type="text/css" href="sourse.css">
      ...
      <div class="box1">
        <a href="http://ocw.nthu.edu.tw/ocw/index.php?page=course&cid=7&"><img src="https://i.ytimg.com/vi/apyksA4K0tk/hqdefault.jpg" class="first"></a>
        <a href="http://ocw.nthu.edu.tw/ocw/index.php?page=course&cid=7&" class="title">清華大學開放式課程</br>高淑蓉老師</a>
        <img src="https://image.flaticon.com/icons/svg/189/189671.svg" class="love"><h4 class="fa">Add To My Favorite</h4></img>
      </div>

      <div class="box2">
        <a href="http://ocw.aca.ntu.edu.tw/ntu-ocw/ocw/cou/104S115"><img src="https://i.ytimg.com/vi/p6auMIcNMus/maxresdefault.jpg" class="first"></a>
        <a href="http://ocw.aca.ntu.edu.tw/ntu-ocw/ocw/cou/104S115" class="title">台灣大學開放式課程</br>齊震宇老師</a>
        <img src="https://image.flaticon.com/icons/svg/189/189671.svg" class="love"><h4 class="fa">Add To My Favorite</h4></img>
      </div>

      <div class="box3">
        <a href="http://ocw.nctu.edu.tw/course_detail_3.php?bgid=1&gid=1&nid=490#.WMjxV_l97IU"><img src="https://i.ytimg.com/vi/b9lwzMhRXsQ/mqdefault.jpg" class="first"></a>
        <a href="http://ocw.nctu.edu.tw/course_detail_3.php?bgid=1&gid=1&nid=490#.WMjxV_l97IU" class="title">交通大學開放式課程</br>溫宏斌老師</a>
        <img src="https://image.flaticon.com/icons/svg/189/189671.svg" class="love"><h4 class="fa">Add To My Favorite</h4></img>
      </div>
