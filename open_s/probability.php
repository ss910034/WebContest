...
<body>
    ...
    <link rel="stylesheet" type="text/css" href="sourse.css">
      ...
      <div class="box1">
        <a href="http://ocw.nthu.edu.tw/ocw/index.php?page=course&cid=68"><img src="http://ocw.nthu.edu.tw/ocw/upload/teacher/73/73.jpg" class="first"></a>
        <a href="http://ocw.nthu.edu.tw/ocw/index.php?page=course&cid=68" class="title">清華大學開放式課程</br>鄭少為老師</a>
