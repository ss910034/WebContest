...
<body>
    ...
    <link rel="stylesheet" type="text/css" href="sourse.css">
      ...
      <div class="box1">
        <a href="http://ocw.nctu.edu.tw/course_detail_3.php?bgid=9&gid=0&nid=412#.WMj3Pvl97IU"><img src="http://ytimg.googleusercontent.com/vi/pPMMUa8guTE/mqdefault.jpg" class="first"></a>
        <a href="http://ocw.nctu.edu.tw/course_detail_3.php?bgid=9&gid=0&nid=412#.WMj3Pvl97IU" class="title">交通大學開放式課程</br>彭文志老師</a>
        <img src="https://image.flaticon.com/icons/svg/189/189671.svg" class="love"><h4 class="fa">Add To My Favorite</h4></img>
      </div>

      <div class="box2">
        <a href="http://bio.cse.nsysu.edu.tw/ds/new_ds_video.htm"><img src="https://i.ytimg.com/vi/4zHRf-dB8FI/maxresdefault.jpg" class="first"></a>
        <a href="http://bio.cse.nsysu.edu.tw/ds/new_ds_video.htm" class="title">中山大學開放式課程</br>楊昌彪老師</a>
        <img src="https://image.flaticon.com/icons/svg/189/189671.svg" class="love"><h4 class="fa">Add To My Favorite</h4></img>
      </div>
