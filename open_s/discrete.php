...
<body>
    ...
    <link rel="stylesheet" type="text/css" href="sourse.css">
      ...
      <div class="box1">
        <a href="http://ocw.nthu.edu.tw/ocw/index.php?page=course&cid=129&"><img src="http://i.ytimg.com/vi/P1qJ9e7sP08/hqdefault.jpg" class="first"></a>
        <a href="http://ocw.nthu.edu.tw/ocw/index.php?page=course&cid=129&" class="title">清華大學開放式課程</br>韓永楷老師</a>
        <img src="https://image.flaticon.com/icons/svg/189/189671.svg" class="love"><h4 class="fa">Add To My Favorite</h4></img>
      </div>

      <div class="box2">
        <a href="http://ocw.nctu.edu.tw/course_detail_3.php?bgid=9&gid=0&nid=252#.WMj1vPl97IU"><img src="https://i.ytimg.com/vi/p3NP6ajlrLg/mqdefault.jpg" class="first"></a>
        <a href="http://ocw.nctu.edu.tw/course_detail_3.php?bgid=9&gid=0&nid=252#.WMj1vPl97IU" class="title">交通大學開放式課程</br>易志偉老師</a>
        <img src="https://image.flaticon.com/icons/svg/189/189671.svg" class="love"><h4 class="fa">Add To My Favorite</h4></img>
      </div>
